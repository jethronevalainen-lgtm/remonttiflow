    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/40 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="items-center text-center">
          <div className="mb-2 flex h-14 w-14 items-center justify-center rounded-xl bg-primary text-xl font-bold text-primary-foreground">{BRAND.shortName}</div>
        ...
        <CardFooter className="justify-center">
          <p className="text-center text-sm text-muted-foreground">Käyttäjätilit luo organisaation ylläpitäjä. Ota yhteyttä ylläpitäjään, jos tarvitset tunnukset.</p>
        </CardFooter>
      </Card>
    </div>
  );
