...
alter table public.work_orders
  drop constraint if exists work_orders_project_team_requires_project_check;

alter table public.work_orders
  add constraint work_orders_project_team_requires_project_check
  check (assignment_scope <> 'project_team' or project_id is not null);
...
-- Backward-compatible internal overload for clients deployed before this migration.
create or replace function private.save_work_order(
  p_organization_id uuid,
  p_work_order_id uuid,
  p_project_id uuid,
...
as $$
  select private.save_work_order(
...
revoke all on function private.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[], text) from public, anon;
revoke all on function private.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[]) from public, anon;
revoke all on function public.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[], text) from public, anon;
revoke all on function public.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[]) from public, anon;

grant execute on function private.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[], text) to authenticated;
grant execute on function private.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[]) to authenticated;
grant execute on function public.save_work_order(uuid, uuid, uuid, text, date, text, text, text, text, text, uuid[], text) to authenticated;
