...
const DEMO_ACCOUNTS: DemoAccountDefinition[] = [
  { role: 'supervisor', displayName: 'Jussi Heikkinen', jobTitle: 'Työnjohtaja' },
  { role: 'project_coordinator', displayName: 'Emma Saarinen', jobTitle: 'Projektikoordinaattori' },
  { role: 'worker', displayName: 'Aleksi Rantanen', jobTitle: 'Rakennustyöntekijä' },
  { role: 'customer', displayName: 'Minna Koskinen', jobTitle: 'Tilaajan yhteyshenkilö' },
];

const DEMO_ACCOUNT_PHONES: Record<OrganizationRole, string> = {
  supervisor: '040 222 2222',
  project_coordinator: '040 333 3333',
  worker: '040 111 1111',
  customer: '040 123 4567',
};
  ...
  if (!user) {
    const { data, error } = await admin.auth.admin.createUser({
      ...
      user_metadata: {
        ...
        phone: DEMO_ACCOUNT_PHONES[definition.role],
        demo_account: true,
...
async function seedDemoData(
  ...
  const ids = {
    ...
    installerAEmployee: await deterministicUuid(`${ownerUserId}:demo:employee:installer-a`),
    installerBEmployee: await deterministicUuid(`${ownerUserId}:demo:employee:installer-b`),
    electricianEmployee: await deterministicUuid(`${ownerUserId}:demo:employee:electrician`),
    painterEmployee: await deterministicUuid(`${ownerUserId}:demo:employee:painter`),
    apprenticeEmployee: await deterministicUuid(`${ownerUserId}:demo:employee:apprentice`),
  ...
  await upsertRows(admin, 'employees', [
    {
      ...
      emergency_contact_name: 'Mari Rantanen',
      emergency_contact_phone: '040 111 0000',
      tax_number: '1234567-D',
      archived_at: null,
    },
    {
      ...
      status: 'Aktiivinen',
      hourly_cost_cents: 4200,
      employment_type: 'Vakituinen',
      employment_category: 'employee',
      emergency_contact_name: 'Sari Heikkinen',
      emergency_contact_phone: '040 222 0000',
      tax_number: '2234567-D',
      archived_at: null,
    },
    {
      ...
      status: 'Aktiivinen',
      hourly_cost_cents: 3600,
      employment_type: 'Vakituinen',
      employment_category: 'employee',
      emergency_contact_name: 'Antti Saarinen',
      emergency_contact_phone: '040 333 0000',
      tax_number: '3234567-D',
      archived_at: null,
    },
    {
      id: ids.installerAEmployee,
      organization_id: organizationId,
      created_by: ownerUserId,
      user_id: null,
      name: 'Aino Virtanen',
      ...
      phone: '040 444 1001',
      start_date: addDays(today, -520),
      status: 'Aktiivinen',
      hourly_cost_cents: 2750,
      employment_type: 'Vakituinen',
      employment_category: 'employee',
      emergency_contact_name: 'Pekka Virtanen',
      emergency_contact_phone: '040 444 0001',
      tax_number: '4234567-D',
      archived_at: null,
    },
    {
      id: ids.installerBEmployee,
      organization_id: organizationId,
      created_by: ownerUserId,
      user_id: null,
      name: 'Mikko Korhonen',
      ...
      phone: '040 444 1002',
      start_date: addDays(today, -410),
      status: 'Aktiivinen',
      hourly_cost_cents: 2800,
      employment_type: 'Vakituinen',
      employment_category: 'employee',
      emergency_contact_name: 'Liisa Korhonen',
      emergency_contact_phone: '040 444 0002',
      tax_number: '5234567-D',
      archived_at: null,
    },
    {
      id: ids.electricianEmployee,
      organization_id: organizationId,
      created_by: ownerUserId,
      user_id: null,
      name: 'Elias Nieminen',
      ...
      phone: '040 555 1003',
      start_date: addDays(today, -640),
      status: 'Aktiivinen',
      hourly_cost_cents: 3200,
      employment_type: 'Vakituinen',
      employment_category: 'employee',
      emergency_contact_name: 'Noora Nieminen',
      emergency_contact_phone: '040 555 0003',
      tax_number: '6234567-D',
      archived_at: null,
    },
    {
      id: ids.painterEmployee,
      organization_id: organizationId,
      created_by: ownerUserId,
      user_id: null,
      name: 'Sofia Laine',
      role: 'Maalari',
      department: 'Pintatyöt',
      email: `sofia.laine.${ownerUserId.slice(0, 8)}@demo.vakantti.invalid`,
      phone: '040 666 1004',
      start_date: addDays(today, -290),
      status: 'Aktiivinen',
      hourly_cost_cents: 2650,
      employment_type: 'Määräaikainen',
      employment_category: 'employee',
      emergency_contact_name: 'Kalle Laine',
      emergency_contact_phone: '040 666 0004',
      tax_number: '7234567-D',
      archived_at: null,
    },
    {
      id: ids.apprenticeEmployee,
      organization_id: organizationId,
      created_by: ownerUserId,
      user_id: null,
      name: 'Onni Mäkinen',
      ...
      status: 'Aktiivinen',
      hourly_cost_cents: 1800,
      employment_type: 'Harjoittelu',
      employment_category: 'employee',
      emergency_contact_name: 'Helena Mäkinen',
      emergency_contact_phone: '040 777 0005',
      tax_number: '8234567-D',
      archived_at: null,
    },
  ]);

  await upsertRows(admin, 'supervisor_team_members', [
    ids.workerEmployee,
    ids.installerAEmployee,
    ids.installerBEmployee,
    ids.electricianEmployee,
    ids.painterEmployee,
    ids.apprenticeEmployee,
  ].map((employeeId) => ({
    organization_id: organizationId,
